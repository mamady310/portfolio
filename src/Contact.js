    ...
    render() {
       return (
         <div>
          ...
          <a href="https://docs.google.com/document/d/1OrXrQNU2-Q4CGJXcHcmkVJrM7x90MHueoCarOd3I5cw/edit?usp=sharing" target="_blank" rel="noopener noreferrer"><img className="resume" src={Resume} alt="resume"/></a>     
